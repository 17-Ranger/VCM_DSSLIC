...
# class StandardRPNHead(CNNBlockBase):
    """
    ...
    #     if freeze_at >= 1:
    #         self.conv.freeze()
    #         self.objectness_logits.freeze()
    #         self.anchor_deltas.objectness_logits
...
class RPN(nn.Module):
    ...
    def freeze(self, freeze_at=0):
        ...
        """
        if freeze_at >= 1:
            for block in self.rpn_head.children():
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret = {
            ...
            "freeze_at": cfg.MODEL.RPN.FREEZE_AT,
